...
const Sidebar = () => {
  ...
  return (
    <div className="w-72 h-screen bg-[#0f172a] text-white flex flex-col justify-between sticky top-0 shadow-2xl">
      {/* Header */}
      <div>
        <div className="flex items-center justify-center gap-2 py-6 border-b border-gray-700">
          <FitnessCenterIcon sx={{ fontSize: 28, color: "#FACC15" }} />
        ...
        {/* Profile Section */}
        <div className="flex items-center gap-4 bg-slate-800 mx-4 mt-6 p-4 rounded-lg shadow-inner">
          <img
            src={
              user?.photo
            ...
            className="w-12 h-12 rounded-md border-2 border-yellow-400 cursor-pointer"
      ...
      <div className="border-t border-gray-700 py-4">
        <div
          ...
          className="flex items-center justify-center gap-2 text-red-400 hover:text-red-300 cursor-pointer transition"
        >
          <LogoutIcon />
          <span>Logout</span>
        </div>
